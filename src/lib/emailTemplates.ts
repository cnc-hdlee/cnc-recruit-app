...
감사합니다.`,
    // 급여 항목은 사람마다 다르다(업무수당·용인수당·직책수당·PI …).
    // 그래서 항목을 하나하나 변수로 두지 않고, 산정표에 실제로 있는 줄만 모아
    // {{급여내역}} 한 덩어리로 넣는다. 표에 없는 항목은 메일에도 안 나온다.
    variables: ['이름', '부서', '직무', '입사일', '인정경력', '직급', '연봉', '급여내역', '월급여'],
    builtin: true,
    createdAt: 0,
  },
  {
...
감사합니다.
이형도 드림`,
    // 처우 항목은 사람마다 다르다 — 산정표에 있는 줄만 {{처우내역}}으로 들어간다.
    // 항목을 하나씩 박아두면 없는 항목이 "0원"으로 나가거나 있는 항목이 빠진다.
    variables: ['이름', '부서', '입사일', '근무지', '입사장소', '직급', '연봉', '처우내역'],
    builtin: true,
    createdAt: 0,
  },
  {
...
감사합니다.
이형도 드림`,
    variables: ['이름', '부서', '입사일', '직급', '연봉', '처우내역'],
    builtin: true,
    createdAt: 0,
  },
];
