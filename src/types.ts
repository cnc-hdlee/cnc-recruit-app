...
export type PageId = 'dashboard' | 'headcount' | 'incoming' | 'calendar' | 'insights' | 'funnel' | 'rooms' | 'jobcenters' | 'campus' | 'lookup' | 'comms' | 'competitors' | 'comp_kolmar' | 'comp_cosmax' | 'settings' | 'usage';
